...
type ModelFormRules struct {
	...
	ModelFormId uint `json:"model_form_id" form:"model_form_id" binding:"required" required_tips:"请选择" gorm:"column:model_form_id;size:11;not null;default:0;comment:模型表单ID"`
