...
type DataAppModelForm struct {
	Data *AppModel `json:"data" form:"data" binding:"required" required_tips:"参数data不能为空"`
}
...
type DataModelListForm struct {
	Data *modelListForm `json:"data" form:"data" binding:"required" required_tips:"参数data不能为空"`
}
