...
func (ser *modelFormService) GetFormInfo(modelId, isSuper int) []formInfo {
	...
	query := Db.Table(NS.TableName("model_form")+" VMF").
		Select("VMF.model_field_id field_id, VMF.`type`, VMF.default_value,VMF.placeholder, if(VMF.is_disabled = 10, 1, 0) is_disabled, VMF.sort_num, VMF2.field_name, VMF2.label").
