...
type ModelField struct {
	...
	DecimalLength uint `json:"decimal_length" form:"decimal_length"  gorm:"column:decimal_length;size:8;not null;default:0;comment:表的字段为decimal类型时的小数位数"`
	IsNull uint `json:"is_null" form:"is_null"  gorm:"column:is_null;size:8;not null;default:10;comment:是否为空：10=是，20=否"`
	...
	IsAutoIncrement uint `json:"is_auto_increment" form:"is_auto_increment"  gorm:"column:is_auto_increment;size:8;not null;default:20;comment:是否自动递增：10=是，20=否"`
	IsLabel uint `json:"is_label" form:"is_label"  gorm:"column:is_label;size:8;not null;default:20;comment:是否为标题字段：10=是，20=否"`
	IsSigned uint `json:"is_signed" form:"is_signed"  gorm:"column:is_signed;size:8;not null;default:10;comment:是否可为负数：10=是，20=否"`
	IsShow uint `json:"is_show" form:"is_show"  gorm:"column:is_show;size:8;not null;default:10;comment:默认列表中显示：10=显示，20=不显示"`
	IsFixed uint `json:"is_fixed" form:"is_fixed"  gorm:"column:is_fixed;size:8;not null;default:20;comment:默认列表中固定：10=固定，20=不固定"`
	...
	IsFilter uint `json:"is_filter" form:"is_filter"  gorm:"column:is_filter;size:8;not null;default:10;comment:列表中是否可为筛选条件：10=是，20=否"`
