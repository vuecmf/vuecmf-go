...
type ModelForm struct {
	...
	IsDisabled uint `json:"is_disabled" form:"is_disabled"  gorm:"column:is_disabled;size:8;not null;default:20;comment:添加/编辑表单中是否禁用： 10=是，20=否"`
...
type DataModelFormForm struct {
    Data *ModelForm `json:"data" form:"data"`
}